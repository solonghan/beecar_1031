...
$(document).ready(function () {
	...
	let front = userdata.driver_info.vehiclelicense.frontend;
	let backend = userdata.driver_info.vehiclelicense.backend;
	let expired_date = userdata.driver_info.vehiclelicense.expired_date;
	if (front != "" || front) {
		coverImg(front, 1);
	}
	if (backend != "" || backend) {
