            ...
            <div class="card order_card" data-order="${item["order_no"]}">
                <div class="card-body">
                    ...
                    <div class="card-bottom">
                        <div class="remark">
                            <p>行李數 : ${
															item.baggage ? item.baggage + "件" : "無"
														}</p>
                            <p>乘客數 : ${
															item.number ? item.number + "人" : "無"
														}</p>
                            <p>車型 : ${item["car_model"]}</p>
                            <a href="${
															item["sender_id"] != ""
																? `undertack-drive-information?friend_id=${item["sender_id"]}`
																: "javascript:;"
														}">
