                    ...
                    <div class="panel filterable">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="ti-view-list"></i> 編輯產品【<?=$data['name'] ?>】
                            </h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="<?=base_url() ?>mgr/product/edit/<?=$p_id ?>" id="new_form" enctype="multipart/form-data">
                                ...
                                <div class="form-group" id="classify_area">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="classify">
                                            <?
                                                foreach ($classify[$data['category']] as $item) {
                                                    echo '<option value="'.$item['id'].'"';
                                                    if ($item['id'] == $data['classify']) {
                                                        echo ' selected';
                                                    }
                                                    echo '>'.$item['name'].'</option>';
                                                }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="spe1" placeholder ="紅色,藍色" value="<?=$data['specification1'] ?>">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="spe2" placeholder="XL,L,M,S" value="<?=$data['specification2'] ?>">
                                        <small class="text text-danger">請使用逗號『,』分隔，若無請留空</small>
                                    </div>
                                </div> -->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <img src="<?=base_url().$data['photo'] ?>" style="width:150px;">
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control timepick" name="deadline" data-timepicker="true" value="<?=$data['deadline'] ?>" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="des" id="des" style="position: absolute; width: 1px; height: 1px; z-index: -100;"><?=$data['des'] ?></textarea>
                                        <div class="summernote" id="des_sn" style="width: 100%; height: 350px;"><?=$data['des'] ?></div>
                                    </div>
                                </div>
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="payment_des" id="payment_des" style="position: absolute; width: 1px; height: 1px; z-index: -100;"><?=$data['payment_des'] ?></textarea>
                                        <div class="summernote" id="payment_des_sn" style="width: 100%; height: 350px;"><?=$data['payment_des'] ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="rule" id="rule" style="position: absolute; width: 1px; height: 1px; z-index: -100;"><?=$data['rule'] ?></textarea>
                                        <div class="summernote" id="rule_sn" style="width: 100%; height: 350px;"><?=$data['rule'] ?></div>
                                    </div>
                                </div> -->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="status">
                                            <option value="publish"<?=($data['status']=="publish")?'selected':'' ?>>正常</option>
                                            <option value="soldout"<?=($data['status']=="soldout")?'selected':'' ?>>下架</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="button" class="btn btn-block btn-primary submit_btn">編輯</button>
                                    </div>
                                </div>
                            </form>
                        </div>
