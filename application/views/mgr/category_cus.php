...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?= base_url() ?>mgr/funiture/classify">
                    大分類管理
                </a>
            </li>
            <li class="active">子分類管理
            </li>
        </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="row">
                            ...
                            <table class="table horizontal_table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:200px">子分類名稱</th>

                                        <th style="width:30px;">動作</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <form action="<?= base_url() ?>mgr/funiture/category/add" method="POST">
                                        <td>
                                            <input type="text" name="" class="form-control" value="<?= $classify['classify'] ?>" disabled>
                                        </td>
                                        <td>
                                            <input type="text" name="category" class="form-control">
                                        </td>
                                        <input type="hidden" name="classify_id" value="<?= $classify['id'] ?>">
                                        <td>
            ...
            <div class="col-lg-12 col-xs-12">
                <div class="panel filterable">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="ti-view-list"></i> 子分類
                        </h3>
                    </div>
                    <div class="panel-body">
                        <div class="m-t-10">
                            <table class="table horizontal_table table-striped" id="" style="font-size:18px;">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>子分類名稱</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?= $i + 1 ?></td>
                                        <td><?= $item['category'] ?></td>
                                        <td><span style="font-weight:500;">【<?= $classify['classify'] ?>】</span></td>
                                        <td><?= $item['create_date'] ?></td>
                                        <td style="width:10%;">
                                            <button onclick="location.href='<?= base_url() . "mgr/funiture/category/edit/" . $item['id'] ?>'" class="btn btn-primary btn-xs"><span class="fa fa-fw ti-pencil"></span></button>
                                            <button onclick="location.href='<?= base_url() . "mgr/funiture/category/delete/" . $item['id'] ?>'" class="btn btn-danger btn-xs"><span class="fa fa-fw ti-trash"></span></button>
                                        </td>
                                    </tr>
                                    <? } ?>
                                </tbody>
