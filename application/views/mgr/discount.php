        ...
        <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="m-t-10">
                            ...
                            <form action="<?= base_url() ?>mgr/discount/edit_type" method="POST">
                                ...
                                <input type="radio" id="type" name="type" value="0" <? if ($type == 0) { ?>checked <? } ?>>

                                <label for="quantity1">滿額送贈品</label>
                                <input type="radio" id="quantity1" name="type" value="1" <? if ($type == 1) { ?>checked <? } ?>>

                                <label for="quantity">滿額加購商品</label>
                                <input type="radio" id="quantity" name="type" value="2" <? if ($type == 2) { ?>checked <? } ?>>

                                <label for="type1">不使用滿額優惠</label>
                                <input type="radio" id="type1" name="type" value="3" <? if ($type == 3) { ?>checked <? } ?>>
            ...
            <div class="col-lg-12 col-xs-12">
                <div class="panel filterable">
                    ...
                    <div class="panel-body">
                        <button class="pull-right btn btn-md btn-primary" style="margin-right: 25px;" onclick="location.href='<?= base_url() ?>mgr/discount/add/0';">新增滿額折扣</button>
                        <div class="m-t-10">
