                    ...
                    <div class="panel-body">
                        <div class="m-t-10">
                            <table class="table horizontal_table table-striped">
                                ...
                                <tbody>
                                    <form action="<?= base_url() ?>mgr/discount/big_add" method="POST">
                                        <input type="hidden" name="coupon_type" class="form-control" value="2">
                                        <td>
                                        ...
                                        <td>
                                            <select class="form-control select2" name="p_id">
                                                <? foreach ($classify as $c) : ?>
                                                    <option value="<?= $c['id'] ?>"><?= $c['classify'] ?></option>
                                                <? endforeach; ?>
                                            </select>
                                        </td>
                                        <td>
