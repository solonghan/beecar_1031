                    ...
                    <div class="panel filterable">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="ti-view-list"></i> 編輯Q&A
                            </h3>
                        </div>
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="<?=base_url() ?>mgr/qna/detail" id="edit_form" enctype='multipart/form-data'>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea name="answer" id="content" style="position: absolute; width: 1px; height: 1px; z-index: -100;"><?=$data['answer'] ?></textarea>
                                        <div class="summernote" id="content_sn" style="width: 100%; height: 350px;"><?=$data['answer'] ?></div>
                                    </div>
                                </div>
