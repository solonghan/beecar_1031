                    ...
                    <div class="panel filterable">
                        <div class="panel-heading clearfix">
                            <h3 class="panel-title pull-left m-t-6">
                                <i class="ti-view-list"></i> 消費者推薦沙龍
                            </h3>
                        </div>
                            ...
                            <div class="m-t-10">
                                <table class="table horizontal_table table-striped" id="showtable">
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$item['salon_phone']."<br>".$item['salon_addr'] ?></td>
                                        <td><?=$item['recommender']."<br>".$item['recommender_phone'] ?></td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".proccessed").on('click', function(event) {
            ...
            $.ajax({
                url: "<?= base_url() ?>mgr/recommend/proccessed",
                data: {
                    id: id[1]
                },
                type: "POST",
