                            ...
                            <div class="m-t-10">
                                <table class="table horizontal_table table-striped" id="showtable">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?
                                                echo $item['salon']."<br>".$item['email'];
                                            ?>
                                        </td>
                                        <td><?=$item['note'] ?></td>
                                        <td><?=$item['name']."<br>".$item['username']."<br>".$item['phone'] ?></td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".proccessed").on('click', function(event) {
            ...
            $.ajax({
                url: "<?= base_url() ?>mgr/findproduct/proccessed",
                data: {
                    id: id[1]
                },
                type: "POST",
