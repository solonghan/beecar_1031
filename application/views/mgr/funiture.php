                ...
                <div class="panel filterable">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="ti-view-list"></i> <?= $item['title'] ?>
                        </h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <button type="button" class="btn btn-primary btn-block submit_btn" style="margin-top:20px" id="<?= $item['type'] ?>_<?= $item['id'] ?>">更新</button>
                    </div>
                </div>
            </div>
            <? endforeach; ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".submit_btn").on('click', function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>mgr/funiture/intro_edit",
                data: {
                    id: id[1],
                    content: content
                },
