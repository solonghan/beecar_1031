<tr id="tr_<?=$item['id'] ?>">
    ...
    <td>
        <button onclick="location.href='<?=base_url()."mgr/faq/content/".$item['id'] ?>'" class="btn btn-info btn-xs">內容</button>
        
        <button onclick="location.href='<?=base_url()."mgr/faq/classify/edit/".$item['id'] ?>'" class="btn btn-primary btn-xs"><span class="fa fa-fw ti-pencil"></span></button>
