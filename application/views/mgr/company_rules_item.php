<tr id="tr_<?=$item['id'] ?>">
    ...
    <td>
        <? if ($item['url'] != ""): ?>
            <a href="<?=base_url().$item['url'] ?>" target="_blank">下載連結</a>
        <? else: ?>
            無連結
        <? endif; ?>
    </td>
    ...
    <td>
        <button onclick="location.href='<?=base_url()."mgr/financial/company_rules/edit/".$item['id'] ?>'" class="btn btn-primary btn-xs"><span class="fa fa-fw ti-pencil"></span></button>
