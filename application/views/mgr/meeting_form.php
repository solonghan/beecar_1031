                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="POST" action="<?=$action ?>" id="new_form" enctype='multipart/form-data'>
                                ...
                                <? else: ?>
                                        ...
                                        <? elseif ($item[2] == "text_new"): ?>   
                                        <div class="form-group" style="display:inline-block;<?if($item[0]=="電話"||$item[0]=='姓名'){?>margin-left:25px;<?}?>;padding-top:7px;">
                                        <label for="input-text" class="col-sm-3 control-label" style="padding:0px;">
                                        <?
                                            echo $item[0]; 
                                            if ($item[4]) echo "<span class='text text-danger'>*</span>";
                                        ?>
                                        ...
                                        <label for="input-text" class="col-sm-5 control-label">
                                        <?
                                            echo $item[0]; 
                                            if ($item[4]) echo "<span class='text text-danger'>*</span>";
                                        ?>
