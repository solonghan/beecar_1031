                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?
                                                ...
                                                // echo $item['salon_name'];
                                            ?>
                                        </td>
                                        <td><?=($item['first']==1)?"是":"否" ?></td>
                                        <td><?
                                                $second_show = "";
                                                $second = json_decode($item['second'], true);
                                                if (in_array("1", $second)) {
                                                    $second_show .= "網路<br>";
                                                }
                                                if (in_array("2", $second)) {
                                                    $second_show .= "臉書<br>";
                                                }
                                                if (in_array("3", $second)) {
                                                    $second_show .= "社群<br>";
                                                }
                                                if (in_array("4", $second)) {
                                                    $second_show .= "新友<br>";
                                                }
                                                if (in_array("5", $second)) {
                                                    $second_show .= "同事介紹<br>";
                                                }

                                                $second = array_diff($second, ["1","2","3","4","5"]);

                                                if (count($second) > 0) {
                                                    $second_show .= "APODE推廣人員: ".$second[0]."<br>";   
                                                }

                                                if ($second_show != "") {
                                                    echo substr($second_show, 0, strlen($second_show)-2);
                                                }else{
                                                    echo "無";
                                                }
                                            ?>
                                        ...
                                        <td><?
                                                $third_show = "";
                                                $third = json_decode($item['third'], true);
                                                if (in_array("1", $third)) {
                                                    $third_show .= "臉書粉絲頁<br>";
                                                }
                                                if (in_array("2", $third)) {
                                                    $third_show .= "google表單<br>";
                                                }
                                                if (in_array("3", $third)) {
                                                    $third_show .= "沙龍店舖的網頁<br>";
                                                }
                                                if (in_array("4", $third)) {
                                                    $third_show .= "電話預約<br>";
                                                }
                                                if (in_array("5", $third)) {
                                                    $third_show .= "Line預約<br>";
                                                }

                                                // array_diff($third, array("1","2","3","4","5"));
                                                ...
                                                if ($third_show != "") {
                                                    echo substr($third_show, 0, strlen($third_show)-2);
                                                }else{
                                                    echo "無";
                                                }
                                            ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".proccessed").on('click', function(event) {
            ...
            $.ajax({
                url: "<?= base_url() ?>mgr/quest/proccessed",
                data: {
                    id: id[1]
                },
                type: "POST",
