                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="input-text" class="col-sm-4 control-label">密碼重置</label>
                                        <div class="col-sm-8">
                                            <button type="button" class="btn btn-md btn-primary submit_btn">重新發送</button>
                                        </div>
                                    </div>
                                </div>                                
                            </div>
