<tr id="tr_<?=$item['id'] ?>">
    ...
    <!-- <td><?=($item['is_head']==1)?'<span class="label label-danger">置頂</span>':'一般' ?></td> -->
    <td><?=$item['create_date'] ?></td>
    <td>
        <button onclick="location.href='<?=base_url()."mgr/news/edit/".$item['id'] ?>'" class="btn btn-primary btn-xs"><span class="fa fa-fw ti-pencil"></span></button>
