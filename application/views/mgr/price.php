                ...
                <div class="panel filterable">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left m-t-6">
                            <i class="ti-view-list"></i> 滿額加購商品設定管理
                        </h3>
                    </div>
                    <div class="panel-body">
                        <button class="pull-right btn btn-md btn-primary" style="margin-right: 25px;" onclick="location.href='<?= base_url() ?>mgr/discount/add/2';">新增滿額加購商品條件</button>
                        <div class="m-t-10">
                                ...
                                <tbody>
                                    <? for ($i = 0; $i < count($list_1); $i++) {
                                        ...
                                        <tr data-id='<?= $item['id'] ?>'>
                                            ...
                                            <td><button onclick="location.href='<?= base_url() . "mgr/priceproduct/index/" . $item['id'] ?>'" class="btn btn-success">新增加購贈品</button></td>
...
<script>
    ...
    $(document).on('click', ".edit-btn", function(event) {
        var id = $(this).closest('tr').attr("data-id");
        location.href = '<?= base_url() ?>mgr/discount/price_edit/' + id;
    });
</script>
</body>
