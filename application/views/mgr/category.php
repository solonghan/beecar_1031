...
<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?= base_url() ?>mgr/product/classify">
                    大分類管理
                </a>
            </li>
                    ...
                    <div class="panel-body">
                        <div class="m-t-10">
                            <table class="table horizontal_table table-striped">
                                ...
                                <tbody>
                                    <form action="<?= base_url() ?>mgr/product/category/add" method="POST">
                                        <td>
                            ...
                            <table class="table horizontal_table table-striped" id="" style="font-size:18px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:10%;">
                                            <button onclick="location.href='<?= base_url() . "mgr/product/category/edit/" . $item['id'] ?>'" class="btn btn-primary btn-xs"><span class="fa fa-fw ti-pencil"></span></button>
                                            <button onclick="location.href='<?= base_url() . "mgr/product/category/delete/" . $item['id'] ?>'" class="btn btn-danger btn-xs"><span class="fa fa-fw ti-trash"></span></button>
                                        </td>
                                    </tr>
                                    <? } ?>
                                </tbody>
