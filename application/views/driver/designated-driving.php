...
<body class="bg-light">
    ...
    <div class="modal fade dialogbox" id="assigned" data-backdrop="static" tabindex="-1" role="dialog">
    ...
    <script src="<?=base_url()?>assets/custom/APIJs/assign.js?v=002"></script>
