...
<body>
    ...
    <div id="appCapsule">
            ...
            <div class="pl-2 pr-2">
                <div class="search-form">
                    <div class="form-group searchbox">
                        <input type="text" class="form-control order_contact_person" placeholder="請輸入聯絡人電話" required>
        ...
        <div class="create_order mb-2 mt-2" id="sliderCard">
            <!-- <div class="carousel-single owl-carousel owl-theme carousel_order_card">
                <div class="item">
                    <div class="card">
                        <div class="card-body">
        ...
        <!-- <div class="section full mb-2 mt-2 userrecord">
