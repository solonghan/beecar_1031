...
<body class="bg-light">
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">駕照驗證</div>
        <div class="right"></div>
    </div>
    <div id="appCapsule">
        <div class="section-title bg-gray fs-6 text-info p-2">駕照驗證</div>
        <div class="section full mb-2">
            <div class="wide-block pt-2 border-bottom-0">
                <form>
                    <h5 class="fs-6">請上傳駕照正面照</h5>
        ...
        <div class="section full mb-2">
            <div class="section-title bg-gray fs-6 text-info p-2">有效日期填寫</div>
            <div class="wide-block pt-2 border-bottom-0">
                <div class="form-group boxed mb-2">
                    <div class="input-wrapper">
                        <label class="label fs-6" for="expiredDate">請填寫駕照之有效期限</label>
    ...
    <script src="<?=base_url()?>assets/custom/APIJs/drivers-license.js"></script>
</body>
