...
<body class="bg-light">
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">車輛驗證</div>
        <div class="right"></div>
    </div>
    <div id="appCapsule">
        <div class="section-title bg-gray fs-6 text-info p-2">車輛照片</div>
        <div class="section full">
            <div class="wide-block pt-2 border-0">
                <form class="mb-2">
                    <h5 class="fs-6">請上傳車輛前面照</h5>
        ...
        <div class="section full mb-5">
            <div class="wide-block border-0">
                <form>
                    <h5 class="fs-6">請上傳車輛後面照</h5>
                    <div class="custom-file-upload">
    ...
    <script src="<?=base_url()?>assets/custom/APIJs/vehicle-verify.js"></script>
</body>
</html>