...
<body class="bg-light">
    ...
    <div id="appCapsule">
        ...
        <div class="section">
            <input type="button" class="btn btn-primary btn-lg btn-block" value="新增" data-toggle="modal" data-target="#addGroup"></input>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="btn-list">
                        <a href="<?=base_url()?>car/driver-Information" class="btn btn-text-secondary btn-block" data-dismiss="modal">關閉</a>
                    </div>
                </div>
            </div>
        </div>
